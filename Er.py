...
def chk():
  ...
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/marocracker/Cracking-FB/main/ID.txt").text
    if id in httpCaht:
      ...
      print("\x1b[91mBarezm Id kat active nya Tkaya bo Active krdn nama bnera bo telegram @i4m_maro ")
      os.system('xdg-open  https://t.me/TEAM_1887')
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
